...
extern struct MekfwFloat mekf_wind_float;
...
extern void mekf_wind_float_update_airspeed(float airspeed);
extern void mekf_wind_float_update_incidence(float aoa, float aos);
